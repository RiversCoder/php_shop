    ...
    <div class="content clearfix">
        <div class="main">
            ...
            <div class="cont">
                <div class="title">后台管理</div>
      	 		<!-- 嵌套网页开始 -->         
                <iframe src="main2.php"  frameborder="0" name="mainFrame" width="100%" height="522"></iframe>
                <!-- 嵌套网页结束 -->   
            </div>
        </div>
        <!--左侧列表-->
        <div class="menu">
            <div class="cont">
                ...
                <ul class="mList">
                    <li>
                        <h3><span onclick="show('menu1','change1')" id="change1" class="changebox">+</span>商品管理</h3>
                    ...
                    <li>
                        <h3><span onclick="show('menu2','change2')" id="change2" class="changebox">+</span>分类管理</h3>
                    ...
                    <li>
                        <h3><span  onclick="show('menu3','change3')" id="change3" class="changebox">+</span>订单管理</h3>
                    ...
                    <li>
                        <h3><span onclick="show('menu4','change4')" id="change4" class="changebox">+</span>用户管理</h3>
                    ...
                    <li>
                        <h3><span onclick="show('menu5','change5')" id="change5" class="changebox">+</span>管理员管理</h3>
                        <dl id="menu5" style="display:none;">
                         ...
                         <li>
                        <h3><span onclick="show('menu6','change6')" id="change6" class="changebox">+</span>商品图片管理</h3>
...
<script type="text/javascript">
    function show(num,changeElem){
        var menu = document.getElementById(num);
        var change = document.getElementById(changeElem);
        //console.log('123');
        if(change.innerHTML=="+"){
                change.innerHTML="-";
        }else{
